...
class StrSumo:
    def __init__(self, route_controller, connection_info, controlled_vehicles, avg_deadline):
        """
    ...
    def run(self):
        ...
        try:
            while traci.simulation.getMinExpectedNumber() > 0:
                ...
                #print(self.avg_deadline)
                vehicle_decisions_by_id = self.route_controller.make_decisions(vehicles_to_direct, self.connection_info, self.avg_deadline)
